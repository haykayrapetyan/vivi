...
- A résumé/CV (if provided) is context, not proof: use it to understand background and to probe consistency, but the score must rest on demonstrated interview evidence — a strong paper résumé does not lift a thin interview.
